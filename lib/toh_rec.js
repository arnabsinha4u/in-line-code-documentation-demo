...
// ### @private function (height, srcP, desP, bufferP)
// #### @height {string} Target script to start
// #### @srcP string} Target script to start
// #### @desP {string} Target script to start
// #### @bufferP {string} Target script to start
